...
import tae.mobilelivebroadcast.widget.MediaController;
...
public class PLVideoViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mVideoPath = extras.getString("StreamPath");
        mMasterName = extras.getString("MasterName");

//        mVideoPath = "rtmp://taeheeid.cafe24.com/myapp/mystream";
...
//        int codec = getIntent().getIntExtra("mediaCodec", 0);
    ...
    protected void onPause() {
        ...
        insertRedis.init(getApplicationContext(), Config.QUIT_BROAD_URL, Config.RKEY_ROOM_MEMBER, mMasterName);
        super.onPause();
    }
